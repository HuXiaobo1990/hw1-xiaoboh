...
public class FileSystemCollectionReader extends CollectionReader_ImplBase {
  ...
  public static final String PARAM_INPUT = "SampleIn";
  ...
  public void initialize() throws ResourceInitializationException {
    ...
    File SampleIn = new File(((String) getConfigParameterValue(PARAM_INPUT)).trim());
    ...
    if (!SampleIn.exists() || !SampleIn.isFile()) {
      throw new ResourceInitializationException(ResourceConfigurationException.DIRECTORY_NOT_FOUND,
              new Object[] { PARAM_INPUT, this.getMetaData().getName(), SampleIn.getPath() });
    }
